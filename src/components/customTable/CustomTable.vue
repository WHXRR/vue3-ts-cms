...
const props = defineProps({
  ...
  tableColumnConfig: { type: Boolean, default: true },
...
watch(
  () => checkboxList.value,
  (newValue) => {
    tableColumns.value = newValue.filter((item) => item.checked)
  },
  {
    immediate: true,
    deep: true
...
<template>
  <div class="custom-table">
    <div class="table-icon" v-if="tableColumnConfig">
    ...
    <a-table :columns="tableColumns" :dataSource="dataSource" v-bind="config">
